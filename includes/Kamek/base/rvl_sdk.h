...
void PSMTXConcatArray(const Mtx sourceA, const Mtx *sourcesB, Mtx *destsB,
                      int count);
...
void C_MTXLookAt(Mtx dest, const Vec *cameraPos, const Vec *cameraUp,
                 const Vec *target);
void C_MTXLightFrustum(Mtx dest, f32 top, f32 bottom, f32 left, f32 right,
                       f32 near, f32 scaleS, f32 scaleT, f32 transS,
                       f32 transT);
void C_MTXLightPerspective(Mtx dest, f32 fovy, f32 aspect, f32 scaleS,
                           f32 scaleT, f32 transS, f32 transT);
void C_MTXLightOrtho(Mtx dest, f32 top, f32 bottom, f32 left, f32 right,
                     f32 scaleS, f32 scaleT, f32 transS, f32 transT);
void PSMTXMultVec(const Mtx matrix, const Vec *source, Vec *dest);
void C_MTXFrustum(Mtx44 dest, f32 top, f32 bottom, f32 left, f32 right,
                  f32 near, f32 far);
void C_MTXPerspective(Mtx44 dest, f32 fovy, f32 aspect, f32 near, f32 far);
void C_MTXOrtho(Mtx44 dest, f32 top, f32 bottom, f32 left, f32 right, f32 near,
                f32 far);
...
void C_QUATSlerp(const Quaternion *sourceA, const Quaternion *sourceB,
                 Quaternion *dest, f32 value);
