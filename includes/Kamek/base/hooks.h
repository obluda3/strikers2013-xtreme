...
#define kmHook1(type, arg0) kmHookInt(__COUNTER__)[3] = {1, (type), (u32)(arg0)}
...
#define kmHook4(type, arg0, arg1, arg2, arg3)                                  \
  kmHookInt(__COUNTER__)[6] = {4,           (type),      (u32)(arg0),          \
                               (u32)(arg1), (u32)(arg2), (u32)(arg3)}

// kmCondWrite
//   Write value to address, conditionally
#define kmCondWritePointer(addr, original, value)                              \
  kmHook4(kctConditionalWrite, 1, (addr), (value), (original))
#define kmCondWrite32(addr, original, value)                                   \
  kmHook4(kctConditionalWrite, 2, (addr), (value), (original))
#define kmCondWrite16(addr, original, value)                                   \
  kmHook4(kctConditionalWrite, 3, (addr), (value), (original))
#define kmCondWrite8(addr, original, value)                                    \
...
#define kmPatchExitPoint(funcStart, dest)                                      \
  kmHook2(kctPatchExit, (funcStart), (dest))
