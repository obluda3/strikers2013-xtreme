...
namespace MENU_TP_DATA 
{
    ...
    EmblemData EmblemDataTbl[] = 
    {
        ...
        { 83, 5759, "GDS_emb_kurokishidan" },
        { 84, 5759, "GDS_emb_eito" },
        { 73, 5759, "GDS_emb_ancientdark" }, 
        { 74, 5759, "GDS_emb_unlimitedshining" }, 
        ...
        { 88, 5759, "GDS_emb_eldorado1" },
        { 86, 5759, "GDS_emb_eldorado2" },
        { 85, 5759, "GDS_emb_eldorado3" },
        { 92, 5759, "GDS_emb_chronostorm" },
        { 90, 5759, "GDS_emb_zan" },
        { 70, 5759, "GDS_emb_garu" }, 
        { 89, 5759, "GDS_emb_giru" },
        { E_RAGNA, 0x1072, "GDS_emb_lagoon" },
        { 77, 5759, "GDS_emb_tsukigami" },
        { 78, 5759, "GDS_emb_vamptym" },
        { 95, 5759, "GDS_emb_excellar" },
        { 75, 5759, "GDS_emb_eartheleven" }, 
        { 82, 5759, "GDS_emb_resistance" },
        { 81, 5759, "GDS_emb_firedragon2" },
        { 96, 5759, "GDS_emb_bigwaves" },
        { 98, 5759, "GDS_emb_shamushiru" },
        { 71, 5759, "GDS_emb_machtiger" }, 
        { 69, 5759, "GDS_emb_stormwolf" }, 
        { 80, 5759, "GDS_emb_sazaanara" },
        { 72, 5759, "GDS_emb_sandorius" }, 
        { 79, 5759, "GDS_emb_ratoniik" },
        { 87, 5759, "GDS_emb_faram" },   
        { 76, 5759, "GDS_emb_ixal" },
        { 91, 5759, "GDS_emb_bigbang" },
        { 93, 5759, "GDS_emb_supernova" },
        { 94, 5759, "GDS_emb_spacerankers" },
    };
