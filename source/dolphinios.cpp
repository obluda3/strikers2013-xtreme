...
int GetSystemTime() { return ReturnValue(IOCTL_DOLPHIN_GET_SYSTEM_TIME); }

int GetSpeedLimit() { return ReturnValue(IOCTL_DOLPHIN_GET_SPEED_LIMIT); }

int GetCPUSpeed() { return ReturnValue(IOCTL_DOLPHIN_GET_CPU_SPEED); }
