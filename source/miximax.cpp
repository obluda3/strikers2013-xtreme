...
Miximax g_MiximaxTable[] = {
    ...
    {P_10010TSURUGI, 0, P_12811TSURUGI, W_MIXIMAX_TRANSFORMATION, W_KIKU_ICHIMONJI, W_DEATH_DROP_B},    
    ...
    {P_12056GAMMA, 0, P_10443OKAZEYA, W_MIXIMAX_TRANSFORMATION, W_NORMAL_DRIBBLE_DODGE_B, 0,},
    {P_10350HAKURYU, 0, P_10444RINNO, W_MIXIMAX_TRANSFORMATION, W_TENCHI_RAIMEI, W_NORMAL_DRIBBLE_JUMP},
    {P_12189REI, 0, P_11780SAN_MAN, W_MIXIMAX_TRANSFORMATION, 0, 0},
    {0xFFFF, 0, 0, 0, 0, 0},
};
...
PLAYER_DEF *LoadNewBodymodel(PLAYER_DEF *plyDef, _PWORK *work, int bodymodel1,
                             int bodymodel2) {
  int team = work->team;
  ...
  char *settings =
      (char *)(0x807ACF00 +
               0xC9C * team); // too lazy to figure the struct out sry
...
// remove check for normal dribbles
kmWrite32(0x8008c1bc, 0x60000000);
